  ...
  return (
    <div>
      <div className="footer-main p-5" style={{ backgroundColor: "#202020" }}>
        <div className="d-flex flex-column flex-md-row justify-content-md-center align-items-center container">
          ...
          <div className=" w-100 w-md-25 text-start">
          ...
          <div className="text-start  w-100 w-md-25">
            <h4 className="fw-bolder text-light mb-3 mt-3 mt-md-0">Support </h4>
            <Link to="story" className="footer-link my-2">
              Customer Support
            </Link>
            <Link to="story" className="footer-link my-2">
          ...
          <div className="text-start w-100 w-md-25 mt-3 mt-md-0">
      ...
      >
        <div className="container d-flex flex-column flex-md-row justify-content-between align-items-center pt-4">
